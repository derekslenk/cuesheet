 ...
 * read-WRITE bun:sqlite handle (WAL + busy_timeout) via the shared
 * `openBunDatabase` helper, same startRuntime call, same SIGINT/SIGTERM
 * shutdown. Config values are pulled through lib/env.ts
