...
async function createStreamGroupV2(groupName, streamName, teamName, url, opts = {}) {
  ...
  try {
    ...
    // Estimated team-box height anchors the streamer label Y even when the team
    // items are missing or positioning throws; the measured layout below overwrites it.
