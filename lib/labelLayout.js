...
// creation path is the single owner of the label look.
...
/** Plate is centered on the 1920px canvas. */
const CANVAS_CENTER_X = 960;

// OBS colors are ABGR. Plate is opaque #002b4b — transparency reads as mud
// over bright game HUDs. Accent is #2e9be6. Team line is white at ~85% alpha.
const PLATE_COLOR = 0xFF4B2B00;
const ACCENT_COLOR = 0xFFE69B2E;
 ...
 */
function computeUnifiedPlateLayout({ teamTextWidth, nameTextWidth, teamTextLength, nameTextLength }) {
  ...
  const plateLeft = Math.round(CANVAS_CENTER_X - plateWidth / 2);
  ...
  return {
    ...
    topBoxHeight,
    bottomBoxHeight,
    // Color boxes use OBS center alignment (0).
    boxCenterX: CANVAS_CENTER_X,
